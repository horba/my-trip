...
export { default as TermsOfUse } from '@views/TermsOfUse.vue';
...
export { default as EntertainmentsNew } from '@views/user/entertainments-new/entertainments-new.view.vue';
